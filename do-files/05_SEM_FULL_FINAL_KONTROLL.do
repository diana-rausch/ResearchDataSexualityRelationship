log using "${logDirectory}04_SEM_Kontroll_ADF_standardized.log", replace
...
log using "${logDirectory}04_SEM_KONTROLL_ADF_teffects.log", replace
...
log using "${logDirectory}04_SEM_Kontroll_ADF_unstandardized.log", replace
